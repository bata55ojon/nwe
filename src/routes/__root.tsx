...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "HotShop — Premium Digital Products" },
      {
        name: "description",
        content:
          "HotShop sells premium digital products with instant access. Browse the collection and complete your order on Telegram.",
      },
      { name: "author", content: "HotShop" },
